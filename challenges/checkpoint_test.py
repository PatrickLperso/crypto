...
sage: EllipticCurve(GF(p), [a,0]).order().factor(algorithm='ecm')
2^96 * 7 * 274177 * 67280421310721 * 11318308927973941931404914103

sage: EllipticCurve(GF(p), [a,1]).order().factor(algorithm='ecm')
71 * 823 * 1229 * 7489 * 30203 * 1275057701 * 5590685618197487513633360286414913886653362665945221

sage: EllipticCurve(GF(p), [a,4]).order().factor(algorithm='ecm')
2^2 * 13 * 19 * 179 * 13003 * 1307093479 * 218034068577407083 * 16884307952548170257 * 1046432164444700044209

sage: EllipticCurve(GF(p), [a,9]).order().factor(algorithm='ecm')
2^2 * 7 * 653 * 72337 * 119591 * 88586821697531 * 8263795586816543575234964957311495031799816731687
"""
